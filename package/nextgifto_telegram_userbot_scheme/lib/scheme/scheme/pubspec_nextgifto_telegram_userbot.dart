...
class PubspecNextgiftoTelegramUserbot extends JsonScheme {
  ...
  static Map get defaultData {
    return {
      "@type": "pubspecNextgiftoTelegramUserbot",
      "name": "example",
      ...
      "platforms": {"@type": "pubspecNextgiftoTelegramUserbotPlatforms", "android": null, "ios": null, "linux": null, "macos": null, "web": null, "windows": null},
      "environment": {"@type": "pubspecNextgiftoTelegramUserbotEnvironment", "sdk": ">=2.18.5 <3.0.0"},
      "dependencies": {
        "@type": "pubspecNextgiftoTelegramUserbotDependencies",
        "flutter": {"@type": "pubspecNextgiftoTelegramUserbotDependenciesExtra", "sdk": "flutter"},
        "cupertino_icons": "^1.0.2"
      },
      "dev_dependencies": {
        "@type": "pubspecNextgiftoTelegramUserbotDevDependencies",
        "lints": "^2.0.0",
        "test": "^1.16.0",
        "packagex": {"@type": "pubspecNextgiftoTelegramUserbotDevDependenciesExtra", "path": "../"},
        "msix": "^1.0.6"
      },
      "nextgifto_telegram_userbot": {"@type": "packageFullTemplatePubspecConfig"}
    };
  }
