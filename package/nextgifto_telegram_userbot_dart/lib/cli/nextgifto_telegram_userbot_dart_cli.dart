...
import 'package:nextgifto_telegram_userbot/api/nextgifto_telegram_userbot_api_core.dart';
import 'package:universal_io/io.dart';

Logger logger = Logger();

Future<void> packageFullTemplateDartCli(List<String> args_raw) async {
  NextgiftoTelegramUserbotDartApi packageFullTemplateDartApi = NextgiftoTelegramUserbotDartApi();
  ...
  NextgiftoTelegramUserbotDartBuildType server_universeDartBuildType = NextgiftoTelegramUserbotDartBuildType.release;

  if (args.contains("--debug")) {
    server_universeDartBuildType = NextgiftoTelegramUserbotDartBuildType.debug;
  }
